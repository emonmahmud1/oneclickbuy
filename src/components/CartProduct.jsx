...
const CartProduct = ({id}) => {
    const {name,discount_amount,product_images,category,buying_price} = useSelector(state => selectProductById(state.products, id)); 
    // console.log(product); 
  return (
              ...
              <div className="flex flex-col justify-between w-full pb-4">
                <div className="flex justify-between w-full pb-2 space-x-2">
                  ...
                  <div className="text-right">
                    <p className="text-lg font-semibold">{buying_price}</p>
